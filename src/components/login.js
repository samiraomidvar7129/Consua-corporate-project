...
const Login = () => {
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      firstName: Yup.string()
        .min(5, "نام حداقل باید ۵  کاراکتر باشد")
        .max(10, "نام حداکثر باید ۱۰ کاراکتر باشد")
        .required("کاربر گرامی ! لطفا فیلد را پر کنید"),
      lastName: Yup.string()
        .max(15, "نام خانوادگی باید ۱۰ کاراکتر باشد")
        .required("کاربر گرامی ! لطفا فیلد را پر کنید"),
      password: Yup.string()
        .min(
          8,
      ...
      email: Yup.string()
        ...
        .min(10, "ایمیل حداقل باید ۱۰ کاراکتر باشد")
        .max(20, "ایمیل حداکثرباید ۳۰ کاراکتر باشد")
        .required("کاربر گرامی ! لطفا فیلد را پر کنید"),
    }),
  });
  ...
  return (
    <div className="loginForm">
      <h3 className="loginForm-title">ثبت نام کنید</h3>
      ...
      <form className="loginForm-item" onSubmit={formik.handleSubmit}>
        ...
        <label htmlFor="filed-input">نام خانوادگی</label>
        <input
        id="lastName"
          className="filed-input"
          type="text"
